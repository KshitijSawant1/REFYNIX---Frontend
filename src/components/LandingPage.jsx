  ...
  return (
    <>
      ...
      <section className="relative bg-white dark:bg-gray-900">
        {/* Gradient Background (Always Behind) */}
        <div className="absolute inset-0 bg-gradient-to-b from-blue-50 to-transparent dark:from-blue-900 z-0"></div>
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
          ...
          <div class="grid md:grid-cols-2 gap-8">
            <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
              ...
              <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4 text-justify">
          ...
          <h1 class="pt-5 mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
            Contributors
          </h1>
